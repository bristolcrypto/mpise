...
base_log_filenames = [
    "intmul-rv64_isa_50_hybrid.log", "intmul-rv64_isa_51_hybrid.log",
    "intmul-rv64_isa_52_hybrid.log", "intmul-rv64_isa_53_hybrid.log",
    "intmul-rv64_isa_54_hybrid.log", "intmul-rv64_isa_55_hybrid.log",
    "intmul-rv64_isa_56_hybrid.log", "intmul-rv64_isa_57_hybrid.log",
    "intmul-rv64_isa_58_hybrid.log", "intmul-rv64_isa_59_hybrid.log",
    "intmul-rv64_isa_60_hybrid.log", "intmul-rv64_isa_61_hybrid.log",
    "intmul-rv64_isa_62_hybrid.log", "intmul-rv64_isa_64_hybrid.log",
]
...
def parse_log_file_data(filepath):
    ...
    try:
        ...
        match_fn = re.search(r'_isa_(\d+)_hybrid.log', os.path.basename(filepath))
...
if not parsed_any_file:
    ...
    fig.text(0.015, 0.5, "(d) RV64G, ISE-supported.",
             horizontalalignment='center', verticalalignment='center',
             rotation='vertical', fontsize=10, transform=fig.transFigure)
