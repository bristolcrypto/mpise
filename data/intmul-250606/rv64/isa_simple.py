...
base_log_filenames = [
    "intmul-rv64_isa_50_simple.log", "intmul-rv64_isa_51_simple.log",
    "intmul-rv64_isa_52_simple.log", "intmul-rv64_isa_53_simple.log",
    "intmul-rv64_isa_54_simple.log", "intmul-rv64_isa_55_simple.log",
    "intmul-rv64_isa_56_simple.log", "intmul-rv64_isa_57_simple.log",
    "intmul-rv64_isa_58_simple.log", "intmul-rv64_isa_59_simple.log",
    "intmul-rv64_isa_60_simple.log", "intmul-rv64_isa_61_simple.log",
    "intmul-rv64_isa_62_simple.log", "intmul-rv64_isa_64_simple.log",
]
...
def parse_log_file_data(filepath):
    ...
    try:
        ...
        match_fn = re.search(r'_isa_(\d+)_simple.log', os.path.basename(filepath))
