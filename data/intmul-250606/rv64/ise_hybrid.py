...
base_log_filenames = [
    "intmul-rv64_ise_50_hybrid.log", "intmul-rv64_ise_51_hybrid.log",
    "intmul-rv64_ise_52_hybrid.log", "intmul-rv64_ise_53_hybrid.log",
    "intmul-rv64_ise_54_hybrid.log", "intmul-rv64_ise_55_hybrid.log",
    "intmul-rv64_ise_56_hybrid.log", "intmul-rv64_ise_57_hybrid.log",
    "intmul-rv64_ise_58_hybrid.log", "intmul-rv64_ise_59_hybrid.log",
    "intmul-rv64_ise_60_hybrid.log", "intmul-rv64_ise_61_hybrid.log",
    "intmul-rv64_ise_62_hybrid.log", "intmul-rv64_ise_64_hybrid.log",
]
...
def parse_log_file_data(filepath):
    ...
    try:
        ...
        match_fn = re.search(r'_ise_(\d+)_hybrid.log', os.path.basename(filepath))
