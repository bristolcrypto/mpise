...
You can use the contents of this folder to analyze runtime data captured for intmul benchmark on Xilinx Genesys 2 FPGA board.

The folder data/intmul-fpga-<date> contains :
1. The original data captured while executing intmul benchmark on the FPGA (Xilinx Genesys 2 board) on said <date> 
