...
# 2. support for multiply-add (in both full- and reduced-radix modes).
...
- Some variants permit a larger radix selector than others.  Simply to 
  ...
  c != 15 => use reduced-radix with implied radix of `c + 49`
...
- generic.
  ...
  f_1(c) = c + 49 if c != 15 (i.e., c means reduced-radix)
  ...
  f_5(c) = c + 49 if c != 15 (i.e., c means reduced-radix)
           w      if c == 15 (i.e., c means    full-radix)
  ```
