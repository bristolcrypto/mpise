...
void test_gfp_arith(int iter)
{
  ...
  static const unsigned char op1h[] =  // 1st operand for testing
    "0x0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF";
  static const unsigned char op2h[] =  // 2nd operand for testing
  ...
  printf("- gfp mul:     ");
  LOAD_CACHE(gfp_mul(resf, op1f, op2f), 10);
  ...
  printf("  r  = %s\n", resh);
  static const unsigned char mulh[] =  // expected result gfp_mul
  ...
  printf("- gfp sqr:     ");
  LOAD_CACHE(gfp_sqr(resf, op1f), 10);
  ...
  int_to_hex(resh, resf, NWORDS);
  printf("  r  = %s\n", resh);
  static const unsigned char sqrh[] =  // expected result gfp_sqr
  ...
  printf("- gfp add:     ");
  LOAD_CACHE(gfp_add(resf, op1f, op2f), 10);
  ...
  int_to_hex(resh, resf, NWORDS);
  printf("  r  = %s\n", resh);
  static const unsigned char addh[] =  // expected result gfp_add
  ...
  printf("- gfp sub:     ");
  LOAD_CACHE(gfp_sub(resf, op1f, op2f), 10);
  ...
  int_to_hex(resh, resf, NWORDS);
  printf("  r  = %s\n", resh);
  static const unsigned char subh[] =  // expected result gfp_sub
  ...
  int_to_hex(resh, resf, NWORDS);
  printf("  r  = %s\n", resh);
  static const unsigned char m32h[] =  // expected result gfp_mul32
...
void test_curve_arith(int iter)
{
  ...
  static const unsigned char xpih[] =  // X-coordinate of 1st point
    "0x09ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF01234A14";
  static const unsigned char zpih[] =  // Z-coordinate of 1st point
    "0x0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABD289";
  static const unsigned char xqih[] =  // X-coordinate of 2nd point
    "0x55FFB4E2550C7DC34EE4B28C243185BE45706FBE12835B01A3030242D807AA98";
  static const unsigned char zqih[] =  // Z-coordinate of 2nd point
    "0x4F692694C19BF17425C712359BDC06A73B1696B180DEB1FEF27B896F72BE5D74";
  static const unsigned char xdih[] =  // x-coordinate of basepoint
  ...
  printf("  Xp = %s\n", resh);
  static const unsigned char xpoh[] =  // expected result for Xp
  ...
  printf("  Zp = %s\n", resh);
  static const unsigned char zpoh[] =  // expected result for Zp
  ...
  printf("  Xq = %s\n", resh);
  static const unsigned char xqoh[] =  // expected result for Xq
  ...
  printf("  Zq = %s\n", resh);
  static const unsigned char zqoh[] =  // expected result for Zq
...
void test_ecdh(void)
{
  ...
  static const unsigned char RFC7748_A[] =  // RFC7748 test vector
    "0x2A2CB91DA5FB77B12A99C0EB872F4CDF4566B25172C1163C7DA518730A6D0777";
  static const unsigned char RFC7748_B[] =  // RFC7748 test vector
