...
// Wrappers for ref10 scalar-mul functions
extern int crypto_scalarmult_curve25519_ref10(unsigned char *, \
  const unsigned char *, const unsigned char *);
extern int crypto_scalarmult_curve25519_ref10_base(unsigned char *, \
  const unsigned char *);

#define mon_mul_varbase(rf, kf, xf) \
  crypto_scalarmult_curve25519_ref10((unsigned char *) (rf), \
  (const unsigned char *) (kf), (const unsigned char *) (xf)) 
